...
//
// For the simplest implementation follow the steps in our getting started guide at
// https://www.bugsplatsoftware.com
//
//
// Copyright 2003-2015, BugSplat 
// All rights reserved.
//
///////////////////////////////////////////////////////////////////////////////
...
{
public:
    //! @param szDatabase database name on bugsplatsoftware.com
    //! @param szApp application name as supplied with PDB files on bugsplatsoftware.com
    //! @param szVersion version identifier as supplied with PDB files on bugsplatsoftware.com
...
public:
    ...
    //! Use to set the default user name
    ...
    //! Use to set the default user email
